  ...
  return (
    <div className="absolute top-0 left-0 w-screen h-screen">
      <div className="pt-96 flex flex-col w-full h-full items-center">
        ...
        <Link href={'/contact/form' + (searchParams.get('demo') && COMMING_SOON ? ('?' + createQueryString('demo', `${searchParams.get('demo')}`)) : '')} className="relative group w-24 h-24 hover:cursor-pointer select-none">
