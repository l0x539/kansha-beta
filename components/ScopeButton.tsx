  ...
  'animate-[float_6s_ease-in-out_infinite_800ms]'][Math.floor(Math.random() * 5)]} ${className}`}>
    <div>
      ...
      <div className='absolute left-0 top-0 right-0 bottom-0 translate-0 opacity-100'>
        <span className='absolute left-1/2 top-1/2 rounded-full cursor-pointer text-white -translate-1/2 flex justify-center items-center transition-all duration-1000 ease w-[calc(95/16*1rem)] h-[calc(95/16*1rem)] text-xl'>{children}</span>
